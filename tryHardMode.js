...
function preload(){
	...
	silverUpsideDownCup = loadImage('silverUpsideDownCup.png')
...
function setup(){
	...
	hardButton.mousePressed(startScreen2)

	startButton = createButton('Start Game')
	startButton.position(70, 300)
	startButton.mousePressed(easyMode)

	startHardButton = createButton('Start Game')
	startHardButton.position(70, 300)
	startHardButton.mousePressed(hardMode)
...
function startScreen1(){
	...
	image(silverUpsideDownCup, furbyX, furbyY, 50,50)
